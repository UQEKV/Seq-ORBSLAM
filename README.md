...
The BoW model using the pre-trained vocabulary is not applied in our loop clourse detection algorithm which is only based on images itself and the image sequence.
